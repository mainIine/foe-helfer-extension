...
let MarketOffers = {
    ...
    CalcBody: () => {
        ...
        for (let i = 0; i < GoodsList.length; i++) {
            ...
            h.push('<td class="goods-image"><span class="goods-sprite sprite-50 sm ' + GoodID + '"></span></td>');
    ...
    */
    CalcEventsTable: async () => {
        ...
        for (let i = 0; i < EventList.length; i++) {
            ...
            h.push('<td class="goods-image"><span class="goods-sprite sprite-50 sm ' + GoodsData[OfferGoodID]['id'] + '"></span></td>');
            ...
            h.push('<td class="goods-image"><span class="goods-sprite sprite-50 sm ' + GoodsData[NeedGoodID]['id'] + '"></span></td>');
