...
let EventHandler = {
	...
	*/
	...
	CalcMoppelHelperTable: async () => {
		...
		let pImage = `<img style="max-width: 22px" src="${srcLinks('/shared/gui/tavern/shop/tavern_shop_boost_shield1_icon.png', true)}" title="${i18n('Boxes.MoppelHelper.CityProtected')}" alt="${i18n('Boxes.MoppelHelper.CityProtected')}"></img>`
