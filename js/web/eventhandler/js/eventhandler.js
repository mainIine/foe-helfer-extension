...
let EventHandler = {
	...
	*/
	...
	CalcMoppelHelperTable: async () => {
		...
		h.push('<th data-type="moppelhelper" class="name-col">' + i18n('Boxes.MoppelHelper.Name') + '</th>');
		if (EventHandler.CurrentPlayerGroup !== 'Guild' && EventHandler.ShowHideColumns.GuildName) {
			h.push('<th data-type="moppelhelper" class="name-col">' + i18n('General.Guild') + '</th>');
		}
		if (EventHandler.ShowHideColumns.Era) {
			h.push('<th class="is-number" data-type="moppelhelper">' + i18n('Boxes.MoppelHelper.Era') + '</th>');
		}
