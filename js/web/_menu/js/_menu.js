...
let _menu = {
	...
	*/
	...
	gexStat_Btn: () => {
		...
		return btn.append(btn_sp, $(`<span id="gex-attempt-count" class="hud-counter" ${localStorage.getItem('HiddenRewards.GEprogress')<79 ? '' : 'style="display:none"'}>${GExAttempts.count||0}</span>`));
	},
