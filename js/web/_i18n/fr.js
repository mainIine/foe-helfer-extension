...
let i18n = {
	...
	"Boxes" : {
		"OwnpartCalculator" : {
			"Title": "Calculs de PF pour mes GM",
		...
		"Calculator": {
			...
			"NoFPorMedsAvailable": "Pas de PF ou plans disponible.",
			...
			"Done": "Fait",
			"LevelWarningTT": "__fpcount__ PF ne rentre pas dedans<br>Investissement maximum : __totalfp__ PF",
			"NegativeProfitTT": "<b>Place non sécurisée !</b><br><b>__fpcount__</b> PF supplémentaires à investir pour le sécuriser<br>Total pour rendre la place sécurisé : <b>__totalfp__</> PF.",
		},
		...
		"StrategyPoints" : {
			"Title" : "PF - Productions",
			"TotalFPs": "Total PF pour tous les bâtiments : ",
			"Amount": "Quantité",
			"FPBar" : "PF en stock : ",
			"BuyableFP" : "Achetable : ",
		},
		...
		"Investment" : {
			...
			"InvestBar" : "PF investis : ",
			"CurrReward" : "Gain actuel : ",
		},
		...
		"Infobox" : {
			...
			"Messages" : {
				...
				"LevelUp" : "Le __building__ de __player__ vient juste d'atteindre le niveau __level__.<br>Tu as pris la <strong>__rank__th</strong> place et obtenu <strong>__fps__</strong> PF en retour.",
	...
	"Menu" : {
		...
		"Calculator" : {
			...
			"Desc" : "Calcule toutes les places pour vous et les PF pour sniper.",
			"Warning": "Désactivé : Ouvrez d'abord le GM d'un autre joueur !",
		},
		"OwnpartCalculator" : {
			"Title" : "Calculatrice GM interne",
			"Desc" : "Crée un plan de pose de PF, calcule les coûts et copie les valeurs.",
			"Warning": "Désactivé : Ouvrez d'abord un de vos GM !",
        },
        "Technologies": {
		...
		"Chat" : {
			...
			"Desc" : "Discussion en temps réel avec tout le monde.",
		},
		"Unit" : {
			"Title" : "Armées",
		...
		"OutP" : {
            ...
            "DescWarningOutpostData": "<em id='outPW' class='tooltip-error'>Désactivé : Démarrez une Colonie et rechargez le jeu [F5]</em>",
	...
	"Settings" : {
		...
		"SendInvestigations": {
			"Title" : "Investissements des PF",
			"Desc" : "Ouvrir l'Hôtel de Ville > Nouvelles > Grand monuments : cela enverra l'info des PF investis.",
		},
		"ShowTavernBadge": {
		...
		"PreScanLGList": {
			...
			"Desc" : "Parcours la liste générale du voisin à l'ouverture et détermine les GM éventuellement remplissables.<br> <u>Remarque :</u> Les dernières places étant uniquement transmises lors de l'ouverture d'un GM, le résultat peut être différent.<br>L'analyse est cependant enregistrée.",
		},
	...
	"API" : {
		...
		"LGGildMember" : "Les GM de __player__ ont été envoyés."
	},
