...
let stPatrick = {
    ...
    ShowDialog: () => {
        ...
        htmltext += `<img src="${srcLinks("/shared/seasonalevents/stpatricks/event/stpatrick_task_idle_currency_thumb.png", true)}" alt="" >`;
        ...
        htmltext += `<td><img src="${srcLinks("/shared/seasonalevents/stpatricks/event/stpatrick_task_goods_hats_thumb.png", true)}" alt="" ></td>`;
        ...
        htmltext += `<td><img src="${srcLinks("/shared/seasonalevents/stpatricks/event/stpatrick_task_goods_flowers_thumb.png", true)}" alt="" ></td>`;
        ...
        htmltext += `<td><img src="${srcLinks("/shared/seasonalevents/stpatricks/event/stpatrick_task_goods_cake_thumb.png", true)}" alt="" ></td>`;
        ...
        htmltext += `<td><img src="${srcLinks("/shared/seasonalevents/stpatricks/event/stpatrick_task_goods_drinks_thumb.png", true)}" alt="" ></td>`;
        ...
        htmltext += `<td><img src="${srcLinks("/shared/seasonalevents/stpatricks/event/stpatrick_task_goods_fireworks_thumb.png", true)}" alt="" ></td>`;
        ...
        htmltext += `<td><img src="${srcLinks("/shared/seasonalevents/stpatricks/event/stpatrick_task_shipyard_thumb.png", true)}" alt="" ></td>`;
        ...
        htmltext += `<td><img src="${srcLinks("/shared/seasonalevents/stpatricks/event/stpatrick_task_parade_thumb.png", true)}" alt="" ></td>`;
