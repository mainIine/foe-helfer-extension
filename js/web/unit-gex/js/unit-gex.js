...
let UnitGex = {
	...
	PrepareUnit: (entry)=> {
		...
		return `<span class="unit_icon ${entry['unitTypeId']} unit_skill ${type['unitClass']}" style="background-image:url('${srcLinks("/shared/unit_portraits/armyuniticons_50x50/armyuniticons_50x50_0.png", true)}')"><span class="health"><span class="fit" style="width:${fit}%"></span></span></span>`;
	},
