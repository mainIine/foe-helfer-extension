...
let CityMap = {
	...
	PrepareBox: (Title)=> {
		...
		if (CityMap.IsExtern === false) {
			menu.append($('<button />').addClass('btn-default ml-auto').attr({ id: 'highlight-old-buildings', onclick: 'CityMap.highlightOldBuildings()' }).text(i18n('CityMap.HighlightOldBuildings')));
