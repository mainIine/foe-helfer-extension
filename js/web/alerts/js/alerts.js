...
const BattlegroundSectorNames = {
	...
	waterfall_archipelago: {
		...
		2: {title: "A3A", name: "Micianary"},
		3: {title: "A3B", name: "Sheaggasia"},
		4: {title: "A4A", name: "Phiossiania"},
		5: {title: "A4B", name: "Klitimelan"},
		6: {title: "A4C", name: "Ioclequey"},
		7: {title: "A5A", name: "Appiatoph"},
		8: {title: "A5B", name: "Cuchrarahe"},
		9: {title: "A5C", name: "Eokkirune"},
		10: {title: "A5D", name: "Iyoriyaz"},
		11: {title: "B2A", name: "Achinata"},
		12: {title: "B3A", name: "Birrathan"},
		13: {title: "B3B", name: "Phiodeanet"},
		14: {title: "B4A", name: "Lastaruz"},
		15: {title: "B4B", name: "Ecceacyre"},
		16: {title: "B4C", name: "Yastalyn"},
		17: {title: "B5A", name: "Strennearial"},
		18: {title: "B5B", name: "Atherathios"},
		19: {title: "B5C", name: "Xeaxudin"},
		20: {title: "B5D", name: "Stronolyn"},
		21: {title: "C2A", name: "Enudran"},
		22: {title: "C3A", name: "Ioppiorion"},
		23: {title: "C3B", name: "Acyalyn"},
		24: {title: "C4A", name: "Chobbiabis"},
		25: {title: "C4B", name: "Mioccijan"},
		26: {title: "C4C", name: "Cheabenium"},
		27: {title: "C5A", name: "Stuckodod"},
		28: {title: "C5B", name: "Kazazriel"},
		29: {title: "C5C", name: "Pilitallios"},
		30: {title: "C5D", name: "Xishotish"},
		31: {title: "D2A", name: "Zebbeasos"},
		32: {title: "D3A", name: "Giobbolas"},
		33: {title: "D3B", name: "Briocealyn"},
		34: {title: "D4A", name: "Diodiriel"},
		35: {title: "D4B", name: "Driqela"},
		36: {title: "D4C", name: "Gakiaran"},
		37: {title: "D5A", name: "Gegleadore"},
		38: {title: "D5B", name: "Wrorrulan"},
		39: {title: "D5C", name: "Cleoseotophy"},
		40: {title: "D5D", name: "Equioque"},
		41: {title: "E2A", name: "Appatinaka"},
		42: {title: "E3A", name: "Joviolmond"},
		43: {title: "E3B", name: "Ciobiathis"},
		44: {title: "E4A", name: "Phulotora"},
		45: {title: "E4B", name: "Iccothaer"},
		46: {title: "E4C", name: "Ohephere"},
		47: {title: "E5A", name: "Eatutiar"},
		48: {title: "E5B", name: "Kaweariael"},
		49: {title: "E5C", name: "Yossiryon"},
		50: {title: "E5D", name: "Ecladorth"},
		51: {title: "F2A", name: "Kracciarhia"},
		52: {title: "F3A", name: "Preammirune"},
		53: {title: "F3B", name: "Exoryme"},
		54: {title: "F4A", name: "Xioceomos"},
		55: {title: "F4B", name: "Oglilyn"},
		56: {title: "F4C", name: "Omialanto"},
