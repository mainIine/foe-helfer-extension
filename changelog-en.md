...
- Change notification sound! Check the settings to chose from seven different sound effects
- Window Pop Outs: You can try an alpha version of the efficiency window. It will not have full functionality
